...
public class MultilevelQueue extends Escalonador {
    ...
    public void escalonar() {
        ...
        while(!todos.isEmpty()) {
            ...
            if(filaAlta.isEmpty())
                instanteAtual = executarFilaBaixa(instanteAtual);
            
            instanteAtual = executarFilaAlta(instanteAtual);
        }

    }

    private int executarFilaAlta(int instante) {
    ...
    private int executarFilaBaixa(int instante) {
